...
import { RefreshCw, LogOut, Moon, Sun, Server, Plus, Upload, FileUp, Trash2, RotateCcw, CheckCircle2,Mail } from 'lucide-react'
...
export function Dashboard({ onLogout }: DashboardProps) {
  ...
  const [kamImportDialogOpen, setKamImportDialogOpen,emailSettingsDialogOpen, setEmailSettingsDialogOpen] = useState(false)
